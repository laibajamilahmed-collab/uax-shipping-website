...
import "./CarFreight.css";

const advantages = [
  {
    icon: "fas fa-handshake",
    title: "WE ARE TRUSTED",
    desc: "Trusted by businesses and individuals for reliable, secure, and efficient logistics solutions.Our commitment to quality service and on-time delivery has earned the confidence of our customers worldwide.",
  },
  {
    icon: "fas fa-lock",
...
const CarFreightSection = () => {
  return (
    <section className="carfreight-section">
              ...
              <div className="row g-3 mt-1">
                <div className="col-6">
                  <div className="small-image">
                    <img
                      src="/public/assets/images/Carfreight2.jpg"
                      alt=""
                    />
                  </div>
                </div>
                ...
                <div className="col-6">
                  <div className="small-image">
                    <img
                      src="/public/assets/images/Carfreight1.jpg"
                      alt=""
                    />
                  </div>
                </div>
...
export default CarFreightSection;